...
- **Bidirectional** — not read-only. **114 tools** span reading _and_ writing the canvas, so an agent can both implement designs and build them.
...
Figwright exposes **114 MCP tools** in three groups:
